...
export default function Home() {
  ...
  return <main className={`home anomaly-${archive.anomaly}`}>
    <section className="hero">
      ...
      <div className="portrait"><div className="portrait-noise"/><span className="vertical">AUTHOR · 29 · TAIPEI</span><div className="silhouette"><i/><i/></div><p>「寫小說的。還活著。<br/>截稿日前不一定。」</p></div>
    ...
    <section id="works" className="works section"><div className="section-title"><div><p className="eyebrow">SELECTED WORKS</p><h2>作品</h2></div><span>02</span></div>
      ...
      <Link href="/works/stars" className="work-link" onClick={() => archive.disturb(1)}><article><div className="book book-stars"><span>不渡</span><strong>當群星<br/>墜落</strong><i>全五冊</i></div><div><small>FANTASY SERIES · COMPLETE</small><h3>當群星墜落</h3><p>群星墜下的那一夜，王國終於記起自己遺忘過什麼。</p><b>查看作品 <ArrowUpRight size={18}/></b></div></article></Link></div>
    </section>
