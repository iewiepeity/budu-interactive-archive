...
import { worksPraise } from "@/lib/community";
...
export default function Home() {
  ...
  return <main className={`home anomaly-${archive.anomaly}`}>
    ...
    <section className="profile-teaser section"><p className="eyebrow">BEYOND THE DESK</p><h2>不寫稿的時候，<br/>他也沒有比較安分。</h2><p>書買得比看得快、半夜騎車找宵夜、玩合作遊戲先罵隊友——偶爾也會認真生活。</p><Link href="/author" className="primary">閱讀作者側寫 <ArrowUpRight size={17}/></Link></section>
    ...
    <section className="archive-gateway section"><div><p className="eyebrow">UNAUTHORIZED ACCESS</p><h2>創作之外，<br/>有人留下了東西。</h2><p>翻動許哲維的書桌、讀取角色私人註記，或者接受一份沒有任何機構願意背書的魔法測驗。</p></div><div className="gateway-links"><Link href="/desk"><small>01 · INTERACTIVE</small><b>許哲維的書桌</b><span>最後編輯：02:42:57</span></Link><Link href="/characters"><small>02 · CLASSIFIED</small><b>角色檔案</b><span>含作者私人註記</span></Link><Link href="/quiz"><small>03 · DEFINITELY SCIENTIFIC</small><b>魔法傾向測驗</b><span>可能不適合正經人</span></Link><Link href="/archive"><small>04 · LOCAL RECORD</small><b>世界線存檔</b><span>{archive.playthroughs} 次序章完成</span></Link></div></section>
