...
export default function Stars() {
  ...
  return <main className="stars-page">
    ...
    <section className="stars-hero"><div className="star-orbit"><span/><span/><span/><i/></div><div><p className="eyebrow">FIVE-VOLUME FANTASY SERIES</p><h1>當群星墜落</h1><p className="subtitle">THE NIGHT WHEN STARS FALL</p><p className="synopsis">第一顆星辰墜落後，魔物開始異變。亞維爾、菲蕾與葛蘭特從只想活下去的普通人，走上追查災變真相的旅程；直到他們發現，墜落的從來不只是星星。</p><div className="meta"><div><small>類型</small><b>奇幻冒險・群像・災變</b></div><div><small>冊數</small><b>全五冊</b></div><div><small>狀態</small><b className={canRead ? "corrupt" : ""}>{canRead ? "未完待續" : "已完結"}</b></div></div></div></section>
