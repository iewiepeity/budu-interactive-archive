...
const story: Record<string, Node> = {
  ...
  first: { speaker: "陌生男人", text: "……三小？", choices: [
    { text: "你是誰？", next: "who" }, { text: "這裡是哪？", next: "where" }, { text: "你好帥。", next: "handsome", affection: 1, badges: ["handsome"] }, { text: "先摸一下牆壁。", next: "wall" }
  ]},
  ...
  recognition: { speaker: "許哲維", text: "等一下。\n\n妳不是我寫的人。", choices: [{ text: "你也不是。", next: "warning", affection: 1, badges: ["beyond-script"] }, { text: "恭喜，你還認得自己寫的人。", next: "warning", affection: 1 }] },
  ...
  end: { text: "遠處傳來沉重的鐘聲。一下、兩下——第七下沒有響。\n\n許哲維抬頭望向地牢唯一的窄窗。那裡沒有星星，卻有什麼正在墜落。", aside: "序章・完", choices: [{ text: "重新閱讀序章", next: "wake", badges: ["cellmate", "stargazer"] }] }
};
...
export function StoryEngine() {
  ...
  useEffect(() => { archive.unlock("beyond-script"); }, []); // eslint-disable-line
